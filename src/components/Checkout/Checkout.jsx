        ...
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div className="flex flex-col items-start justify-start w-full lg:flex-row">
            ...
            <div className="flex flex-col self-start w-full mr-6 md:w-1/2">
              <h2 className="text-xs font-medium leading-loose tracking-wider text-gray-700 uppercase">
                Resúmen
              </h2>
              ...
              <Link
                to="/cart"
                className="text-white bg-blue-500 rounded-md btn"
              >
                Volver al carrito
              </Link>
            </div>
      ...
      >
        <div className="container items-center justify-center px-4 py-20 mx-auto md:px-10 place-self-center">
          <div className="flex flex-col items-center justify-center px-3 py-12 bg-white md:px-4">
            <h2 className="text-lg font-medium leading-tight tracking-wider text-center text-gray-800 uppercase md:w-9/12 lg:w-7/12">
              ¡Muchas gracias por tu compra {buyer.name.toUpperCase()}!
            </h2>
            <h2 className="text-center md:w-9/12 lg:w-7/12 ">
              ¡Muchas gracias por tu compra {buyer.name.toUpperCase()}!
            </h2>
            <p className="mt-6 text-sm font-light leading-normal tracking-wide text-center text-gray-600 md:w-9/12 lg:w-7/12">
              Te enviamos un mail a {buyer.email.toLowerCase()} con tu orden de
              compra ID: {idCompra}.¡Gracias por visitar D&A Fach@! Esperamos
              que hayas encontrado lo que necesitabas. ¡Nos vemos pronto!
            </p>
            <Link to="/" className="flex justify-center mt-6">
              <button
                onClick={deleteCart}
                className="w-40 py-3 font-medium leading-normal tracking-wider text-center text-white uppercase bg-gray-700 cursor-pointer select-none text-xxs focus:outline-none focus:ring-transparent"
              >
                Volver al inicio
              </button>
            </Link>
